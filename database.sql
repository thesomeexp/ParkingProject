...
) ENGINE=InnoDB AUTO_INCREMENT=13 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='管理员表';
...
INSERT INTO `admin` (`admin_id`, `admin_parent`, `admin_name`, `admin_password`, `admin_phone`, `admin_status`) VALUES (1,0,'沙雕荣密码:111','$2a$10$HOz44nhGldJTiv7F0GNMR.vngmXYsWICOHcoZZ5ZT/Dj.4IrPLPa2','1',1),(2,1,'西巴蓝222','$2a$10$FEBs5eBasimqr1YQ1VWHgetWRsegTtkbJfq9y0qkRBGhY6fEzE5Je','2',2),(3,1,'西巴黄333','$2a$10$FS6Sd47/ll1qtCgoFKrWQepIOvAU1aHuxz934p/f94HC0FKxQ4go.','3',1),(4,2,'西巴蓝1密码222','$2a$10$9o7PoyxA6tL.QwAq6spoBe80/SQC/sZfB8XGWaxWtLffLeftIDr7y','21',2),(5,2,'西巴蓝2密码222','$2a$10$t86GzuEjVFPA34oDSWL.T.NKm7SZSGS33jUhvhgmsF2nngtDp.Yea','22',2),(6,2,'西巴蓝3密码222','$2a$10$SddJytHe7Fm8BgDmihbFnez3ZonHSnJd1Sz8GKqMGwwx7Xo.MPl4O','23',2),(7,5,'西巴蓝221密码222','$2a$10$ZykzdWr/Tl7V22U31Wy1nOIsYN1yKSaVAq5r3KROP2gb6EEqaZhQS','221',2),(8,1,'鬼哥密码444','$2a$10$FqCcU3eRPUEHh382taAzBOpGColENxVRwrvP9laeJhaxIL2hqvU5e','4',1),(9,1,'西巴钟密码777','$2a$10$mYTi7EXC5GcZB/o4MD7cM.5aspUDd5yz5fioh1C4QBNCd80VwLPLm','7',1),(10,1,'巴哥密码888','$2a$10$5fWBFUhFUMtpIaHiXklHeOByAD1MkJUbEs4jdOc9RQ.jwbEYW4k5u','8',1),(11,1,'最终测试而已密码67676767','$2a$10$Aacd5iUaVVsUxb5hLLjmcuguIU5FInGLq/FWOG0I.m7.r6IlwuVnW','67676767',1),(12,1,'8989','$2a$10$c6XLiSW5vHkAT3KpRV74D.VnI9KXebwOMKQi3MFKxZmI8irg9.OPC','8989',1);
...
) ENGINE=InnoDB AUTO_INCREMENT=14 DEFAULT CHARSET=utf8mb4 COMMENT='反馈表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `feedback` (`feedback_id`, `feedback_pid`, `feedback_uid`, `feedback_create_date`, `feedback_content`, `feedback_status`, `feedback_contact`) VALUES (1,36,8,'2021-03-27 23:16:32','我要反馈',1,'13025562311'),(2,36,8,'2021-03-27 23:51:05','我要反馈',1,'13025562311'),(3,35,100026,'2021-03-28 00:14:51','培英院能不能加张图?',1,'不告诉你'),(4,35,100026,'2021-03-28 00:15:03','培英院能不能加张图?',1,'13025562311'),(5,32,100026,'2021-03-28 00:29:35','综B的入口不好找, 怎么办',1,'1'),(6,34,100026,'2021-03-28 00:30:00','教四都没画好停车线',0,'1'),(7,35,100026,'2021-03-28 00:30:25','这是建议测试',1,'1'),(8,35,100026,'2021-03-28 00:30:32','建议2',0,'2'),(9,120074,8,'2021-04-16 19:19:00','我要反馈',0,'17450856@qq.com'),(10,120074,8,'2021-04-16 19:19:05','我要反馈2',1,'17450856@qq.com'),(11,120075,100029,'2021-04-16 23:19:27','反馈反馈反馈反馈反馈反馈反馈反馈反馈反馈反馈反馈反馈反馈反馈反馈反馈反馈反馈反馈反馈反馈反馈反馈反馈反馈反馈反馈反馈反馈反馈反馈反馈反馈反馈反馈反馈反馈反馈反馈反馈反馈反馈反馈反馈反馈反馈反馈反馈反馈',0,'32ujgd@gmail.com'),(12,32,100031,'2021-04-22 01:17:23','反馈测试',1,'134155'),(13,120079,100032,'2021-04-24 13:13:18','信息需要更新',1,'123456');
...
) ENGINE=InnoDB AUTO_INCREMENT=120080 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='停车场';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=100045 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='停车场评论';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=109 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='空闲停车场状态表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=100033 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='用户表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `voting` (
  ...
  `voting_tid` int(11) NOT NULL COMMENT '信息id',
...
) ENGINE=InnoDB AUTO_INCREMENT=62 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='信息投票表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2021-04-26 13:00:53
